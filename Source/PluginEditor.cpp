...
JQGunkAudioProcessorEditor::JQGunkAudioProcessorEditor (JQGunkAudioProcessor& p)
    : AudioProcessorEditor (&p),
      ...
      combinedOscSection (p.apvts,
          OscParamIds { "waveform",     "oscLevel",  "unisonVoices",     "unisonDetune",     "unisonBlend",     "octaveShift",     "morph",     "coarseTune",    "fineTune"    },
          OscParamIds { "osc2Waveform", "osc2Level", "osc2UnisonVoices", "osc2UnisonDetune", "osc2UnisonBlend", "osc2OctaveShift", "osc2Morph", "osc2CoarseTune", "osc2FineTune" }),
